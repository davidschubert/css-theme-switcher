...
!function (e, n, t) {
  ...
  function A() {
    ...
    for (var r in d) {
      if (d.hasOwnProperty(r)) {
        if (e = [], n = d[r], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length)) for (t = 0; t < n.options.aliases.length; t++) {
          e.push(n.options.aliases[t].toLowerCase());
        }

        for (A = o(n.fn, "function") ? n.fn() : n.fn, a = 0; a < e.length; a++) {
          i = e[a], s = i.split("."), 1 === s.length ? Modernizr[s[0]] = A : (!Modernizr[s[0]] || Modernizr[s[0]] instanceof Boolean || (Modernizr[s[0]] = new Boolean(Modernizr[s[0]])), Modernizr[s[0]][s[1]] = A), f.push((A ? "" : "no-") + s.join("-"));
        }
      }
    }
  }
  ...
  function l(e, t, o, A) {
    ...
    if (parseInt(o, 10)) for (; o--;) {
      l = s("div"), l.id = A ? A[o] : d + (o + 1), u.appendChild(l);
    }
    return a = s("style"), a.type = "text/css", a.id = "s" + d, (c.fake ? c : u).appendChild(a), c.appendChild(u), a.styleSheet ? a.styleSheet.cssText = e : a.appendChild(n.createTextNode(e)), u.id = d, c.fake && (c.style.background = "", c.style.overflow = "hidden", f = p.style.overflow, p.style.overflow = "hidden", p.appendChild(c)), i = t(u, e), c.fake ? (c.parentNode.removeChild(c), p.style.overflow = f, p.offsetHeight) : u.parentNode.removeChild(u), !!i;
  }
  ...
  }), A(), a(f), delete u.addTest, delete u.addAsyncTest;
...
function showModal() {
  ...
  document.documentElement.classList.toggle("is-locked"); // open modal

  modal.classList.toggle("is-open"); // block pointer events
...
buttonOpenModal.onclick = function () {
  showModal(); //console.info("Button zum Modal öffnen wurde geklickt.");
...
var buttonCloseModal = document.getElementById('btn-open-modal');